...
class OrderServicesController extends AbstractController
{
    ...
    public function displayOrderClient( Request $request,  NormalizerInterface $normalizer,
    UserRepository $userRepository , OrderRepository $orderRepository): Response
    {
    ...
    public function displayOrder( Request $request,  NormalizerInterface $normalizer,
    UserRepository $userRepository , OrderRepository $orderRepository): Response
    {
